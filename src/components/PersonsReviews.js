...
const PersonsReviews = () => {
    ...
    return (
        <div className=' w-[95%] md:w-[85%] mx-auto '>
            {data.length === 0 && <div className='flex items-center justify-center text-2xl font-bold flex-col min-h-screen'><p>!!!</p><p>OOps !!</p><p>NO Data Found</p></div>}
            {data.length > 0 && <h2 className='text-3xl font-bold text-gray-600'>Edit Review </h2>}
