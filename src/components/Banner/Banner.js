    ...
    return (
        <div className='overflow-hidden'>
            <div>
                ...
                <div className='absolute top-32 lg:top-1/3 left-12 lg:left-80 md:left-40 text-start flex items-center
                 justify-center flex-col'>
                    <p className='text-gray-300'>
                        Your Celebration Is in my Eyes</p>
                    <h2 className='text-4xl lg:text-6xl font-bold text-gray-200'>Welcome to the virtual Eyes of Shohan</h2>
